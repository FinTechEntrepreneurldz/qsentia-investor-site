...
const sections = [
  ['Informational use only', 'Qsentia content is provided for educational, research, and informational purposes unless a separate written fund or platform agreement applies. It should not be treated as professional investment, legal, accounting, tax, or financial planning advice.'],
  ...
  ['No offer or solicitation', 'References to QSentia as an investment-management firm, hedge fund, fund strategy, data room, or investor materials do not by themselves constitute an offer to sell, a solicitation to buy, or a recommendation regarding any security, derivative, strategy, or investment product.'],
  ...
  ['Regulatory status', 'QSentia does not represent that publication of research, model access, software, telemetry, or fund-related positioning constitutes registration as an investment adviser, broker, portfolio manager, exchange, or other regulated financial intermediary. The exact legal entity, jurisdiction, regulatory status, offering structure, and investor eligibility standards must be confirmed by counsel before live fund marketing or service.'],
