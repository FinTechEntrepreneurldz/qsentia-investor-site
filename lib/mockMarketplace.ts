...
export const MOCK_MARKETPLACE_MODELS: MarketplaceModel[] = [
  ...
  },
  {
    ...
    slug: 'eth-micro-futures-sentiment-alpha',
    name: 'ETH Micro Futures Sentiment Alpha',
    description:
    ...
    salesOwner: 'Investor Relations',
    onboardingNotes:
      'Micro futures model with monitored drawdown and return telemetry for higher-conviction trading accounts.',
    commercialUpdatedAt: MOCK_BASE_TIMESTAMP,
    tags: ['eth', 'futures', 'sentiment', 'derivatives'],
    repo: 'QSentia-com/eth_micro_futures',
    logsPath: 'logs',
